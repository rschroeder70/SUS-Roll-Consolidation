...
cons_final <- cons_final %>%
  select(-M.I) %>%
  arrange(Year, Plant, Die, desc(Tons))
...
cons_final <- cons_final %>% 
  select(Year, Board.Caliper, Fac, Grade, Board.Width, Dia, Wind, Plant, 
...
cons_final <- cons_final %>%
  arrange(Year, Board.Caliper, Fac, Grade, Board.Width, Dia, Wind, Plant,
          Die, Tons)
